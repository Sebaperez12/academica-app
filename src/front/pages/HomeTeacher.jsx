...
export const HomeTeacher = () => {
  ...
  const getTeacherTodos = async () => {
    ...
    try {
      ...
      if (!resp.ok) throw new Error("Aún no tienes tareas creadas");
  ...
  const getTeacherReadings = async () => {
    ...
    try {
      ...
      const data = await resp.json().catch(() => ([]));
      if (!resp.ok) throw new Error("Error al cargar lecturas");
          ...
          <div className="row align-items-center g-4">
            <div className="col-12 col-lg-6">
              ...
              <p className="fs-6 fs-md-5 mb-0">
                Aquí podrás gestionar las tareas y lecturas de tus estudiantes de manera eficiente y organizada.
              </p>
            </div>
            ...
            <div className="col-12 col-lg-6 text-center">
              <img
                ...
                className="img-fluid rounded-5 hero-teacher-img"
                alt="novedades"
              />
            </div>
          </div>
